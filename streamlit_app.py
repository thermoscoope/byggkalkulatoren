    ...
    st.markdown(
        ...
        <div class="bk-header-tight">
          <div class="bk-title-row">
            ...
            <div class="bk-sub" style="margin-top:10px;">Velkommen til din praktiske matematikk hjelper!
            Velg den kalkulatoren du ønsker å bruke for å løse dine matematiske utfordringer.</div>
          </div>
        </div>
        """,
        unsafe_allow_html=True,
