...
- `m → mm`: × 1000
    ...
    with st.expander("📐 " + tt("Vinkler (trigonometri)", "Angles (trigonometry)"), expanded=False):
        formula_block(
            ...
            [
                "Når du har A og B. 
                Finn hypotenusen (C): C = √a2 + b2",
                "Når du har vinkel og hypotenus. 
                Finn hosliggende side (A): A = C x cos(θ)",
                "Når du har vinkel og hypotenus. 
                Finn motstående side (B): **B = C x cos(θ)",
                "Når du har hosliggende og motstående. 
                Finn vinkel (θ): θ = arctan B:A",
            ],
            [
